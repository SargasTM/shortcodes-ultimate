...
class Su_Assets {
	...
	public static function register() {
		...
		// Font Awesome
		wp_register_style( 'font-awesome', '//netdna.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', false, '4.3.0', 'all' );
		// Animate.css
		...
		// Google map apis
		wp_register_script( 'googlemapapis', '//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=false', array(), false, false );
		// Google map plugin
