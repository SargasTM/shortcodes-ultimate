	...
	public static function shortcodes( $shortcode = false ) {
		$shortcodes = apply_filters( 'su/data/shortcodes', array(
				...
				'row' => array(
					...
					'atts'  => array(
						'type' => array(
							'type'   => 'select',
							'values' => array(
								'fixed-width' => __( 'Fixed Width', 'su' ),
								'full-width'  => __( 'Full Width', 'su' ),
							),
							'default' => 'fixed-width',
							'name' => __( 'Type', 'su' ),
							'desc' => __( 'Type width', 'su' )
						),
						'class' => array(
							'default' => '',
							'name'    => __( 'Class', 'su' ),
				...
				'col' => array(
					...
					'atts' => array(
						'size' => array(
							...
							'name'    => __( 'Size', 'su' ),
							'desc'    => __( 'Select column width.', 'su' ),
						),
						'offset' => array(
							'type'    => 'responsive',
							'default' => 'none',
							'name'    => __( 'Offset', 'su' ),
							'desc'    => __( 'Select column offset.', 'su' ),
						),
						'pull' => array(
							'type'    => 'responsive',
							'default' => 'none',
							'name'    => __( 'Pull', 'su' ),
							'desc'    => __( 'Select column pull.', 'su' ),
						),
						'push' => array(
							'type'    => 'responsive',
							'default' => 'none',
							'name'    => __( 'Push', 'su' ),
							'desc'    => __( 'Select column push.', 'su' ),
						),
						'class' => array(
							'default' => '',
							'name'    => __( 'Class', 'su' ),
				...
				'col_inner' => array(
					...
					'content' => __( 'Column content', 'su' ),
					'desc'    => __( 'Flexible and responsive columns', 'su' ),
					'note'    => __( 'Did you know that you need to wrap columns with [row_inner] shortcode?', 'su' ),
					'icon'    => 'columns',
				),
				// list
				'list' => array(
